...
func (c *calcServiceClient) PostResult(ctx context.Context, in *PostResultRequest, opts ...grpc.CallOption) (*PostResultResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedCalcServiceServer) PostResult(context.Context, *PostResultRequest) (*PostResultResponse, error) {
